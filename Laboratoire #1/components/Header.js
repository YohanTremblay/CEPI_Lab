function HeaderComp(props){
    ...
    <nav className="navbar navbar-expand-lg bg-body-tertiary">
      <div className="container-fluid colorback">
          <div className="col-lg-4 align-self-center"><img src="\style\Image\Logo.PNG" alt="Italian Trulli"/></div>
        ...
        <div className="col-lg-1 "><img id="transparent" src="\style\Image\LogoProfile.png" /></div>
      </div>
